...
title ARTEMIS
REM ============================================================
REM  CLIENT LAUNCHER — LAPTOP 2 (MICTOR / Player 2)
REM
REM  Connects to the host "traffic cop" (/join/p2); the host then
...
REM  This folder is always Player 2 (Mictor).
set "JOIN_KEY=p2"

>"%DIR%artemis-host-ip.txt" echo !HOST_IP!
>"%DIR%artemis-seat.txt" echo 2
...
echo    2^) On Guido, re-copy this folder from scripts\LAPTOP 2\
