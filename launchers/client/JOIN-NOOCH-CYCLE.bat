@echo off
title ARTEMIS - Nooch Cycle Probe
REM Permanent stub — opens host redirect /join/p3-cycle
...
set "URL=http://%HOST_IP%:%PORT%/join/p3-cycle"

echo.
echo  ARTEMIS Cycle Probe — Nooch...
echo  %URL%
echo.
